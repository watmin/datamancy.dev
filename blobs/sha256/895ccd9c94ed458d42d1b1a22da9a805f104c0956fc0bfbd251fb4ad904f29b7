...
form: act
category: primer
reading: to weigh on the balance — test every returned finding against your own living read, never by what you are told
description: Lay the disk bare, strike through an executor, then weigh every returned finding against your own living read — credit nothing the disk does not show. The governing act of the dungeon crawl — study the lair, draw the strike, prove the kill against the ground. Slow is smooth, smooth is fast; never fight the same boss twice.
---
